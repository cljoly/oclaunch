...
(* OASIS_START *)
(* DO NOT EDIT (digest: cfcd7a87a0ed789ef455e59ede04f6fc) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://gitlab.com/WzukW/oclaunch\"";
          synopsis = "Launch commands automatically";
          description =
            Some
              [
                 OASISText.Para
                   "OcLaunch is a command-line tool to launch successively (each time the program is called) commands. It is designed to be used with any program, interactive or not."
              ];
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\017a?\n-\204\005\233\181Q\221\156h\028\001|";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
