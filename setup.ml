...
(* OASIS_START *)
(* DO NOT EDIT (digest: e474a2f05ae231df87cfed4947086f65) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\158\236\188P\029X\n.6\198\165 \173\221\148\189";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
